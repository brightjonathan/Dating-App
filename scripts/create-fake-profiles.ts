//creating fake profiles for texting purposes
...
const SUPABASE_SERVICE_ROLE_KEY = 'add your supabase service role key here ### GO TO PROFILE SETTING AND API KEY TO GET THIS KEY ###';
...
const createFakeProfiles = async()=> {
